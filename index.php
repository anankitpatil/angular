    ...
    <div class="row">
      ...
      <div class="collapse navbar-collapse" id="collapse-navbar">
        <ul class="nav navbar-nav navbar-right">
          <li ng-show="name" ng-class="{active: $location.path() == '/dashboard'}"><a href="#/dashboard">{{name}}</a></li>
          <li ng-class="{active: $location.path() == '/about'}"><a href="#/about">About</a></li>
          <li><a href="#/work" ng-class="{active: $route.current.activetab == 'work'}">Work</a></li>
        </ul>
      </div>
      <!-- /.navbar-collapse --> 
    </div>
...
<div id="authCtrl" ng-controller="authCtrl" style="display:none"></div>
<!-- Libs -->
